...
| 명령어 | 설명 |
|--------|------|
| `/bh-create-workflow` | 입력된 코드나 컨텍스트를 분석하여 Mermaid 워크플로우 다이어그램을 생성하고 HTML 및 Markdown 파일로 저장 |
...
{Mermaid 다이어그램 본문}
    ...
    <div class="footer">
      <span>Generated by bh-create-workflow Assistant</span>
